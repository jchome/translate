...
echo form_open_multipart('Generated/app/editapp/save', $attributes_info, $fields_info );
	...
	<div class="row mb-3"><!-- serveur : nom du serveur et port de l'application, pour contrôle de sécurité -->
		...
		<div class="row">
			<div class="d-flex justify-content-around">
				...
				<a href="<?= base_url() ?>/Generated/app/listapps/index" type="button" class="btn btn-secondary"><?= lang('App.form.button.cancel') ?></a>
			</div>
		</div>
...
<script src="<?= base_url() ?>/js/Generated/app/editapp.js"></script>

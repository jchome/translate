...
echo form_open_multipart('Generated/translation/edittranslation/save', $attributes_info, $fields_info );
...
?>
	...
	<div class="row mb-3"><!-- texte : Traduction pour le texte contenu dans l'élément -->
		...
		<div class="col-10">
			<textarea class="ckeditor" name="html" class="form-control" id="html" 
				><?= $translation['html'] ?></textarea>
	...
	<div class="row mb-3"><!-- texte alternatif : Texte apparaissant à la place d'une image non trouvée -->
		...
		<div class="col-10">
			...
			aria-describedby="altHelp" id="alt" value="<?= $translation['alt'] ?>"  >
	...
	<div class="row mb-3"><!-- texte survol : Texte apparaissant au survol par la souris -->
		...
		<div class="col-10">
			...
			aria-describedby="titleHelp" id="title" value="<?= $translation['title'] ?>"  >
	...
	<div class="row mb-3"><!-- source d'image : Lien http vers l'image traduite -->
		...
		<div class="col-10">
			...
			aria-describedby="srcHelp" id="src" value="<?= $translation['src'] ?>"  >
		...
		<div class="row">
			<div class="d-flex justify-content-around">
				...
				<a href="<?= base_url() ?>/Generated/translation/listtranslations/index" type="button" class="btn btn-secondary"><?= lang('App.form.button.cancel') ?></a>
			</div>
		</div>
...
<script src="<?= base_url() ?>/js/Generated/translation/edittranslation.js"></script>

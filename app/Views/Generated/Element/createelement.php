...
?>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
<?php
echo form_open_multipart('Generated/element/createelement/add', 'class="form-horizontal"');
?>
	...
	<div class="row mb-3"><!-- sélecteur : Sélecteur jQuery de l'objet à traduire -->
		...
		<div class="col-10">
			<input class="form-control" type="text" name="selector" 
				aria-describedby="selectorHelp" id="selector" required  >
	...
	<div class="row mb-3"><!-- page : Lien vers la page -->
		...
		<div class="row">
			<div class="d-flex justify-content-around">
				...
				<a href="<?= base_url() ?>/index.php/Generated/element/listelements/index" type="button" class="btn btn-secondary"><?= lang('App.form.button.cancel') ?></a>
			</div>
		</div>
...
<script src="<?= base_url() ?>/js/Generated/element/createelement.js"></script>

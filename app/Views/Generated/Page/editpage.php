...
echo form_open_multipart('Generated/page/editpage/save', $attributes_info, $fields_info );
...
?>
	...
	<div class="row mb-3"><!-- nom : Nom de la page -->
		...
		<div class="col-10">
			...
			aria-describedby="labelHelp" id="label" value="<?= $page['label'] ?>" required  >
	...
	<div class="row mb-3"><!-- chemin : chemin de la page pour contrôle de sécurité -->
		...
		<div class="col-10">
			...
			aria-describedby="pathHelp" id="path" value="<?= $page['path'] ?>"  >
	...
	<div class="row mb-3"><!-- application : Lien vers l'application -->
		...
		<div class="row">
			<div class="d-flex justify-content-around">
				...
				<a href="<?= base_url() ?>/Generated/page/listpages/index" type="button" class="btn btn-secondary"><?= lang('App.form.button.cancel') ?></a>
			</div>
		</div>
...
<script src="<?= base_url() ?>/js/Generated/page/editpage.js"></script>

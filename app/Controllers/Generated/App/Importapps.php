...
class ImportApps extends \App\Controllers\BaseController {
	...
	public function index(){
		$data = array();
		$this->load->view('Generated/app/importapps_view', $data);
	}
